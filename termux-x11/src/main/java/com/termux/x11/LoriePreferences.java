...
public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
    ...
    // Save the default extra keys layout if it doesn't exist
    if (!p.contains("extra_keys_config")) {
        String defaultLayout = "[[\"ESC\",\"/\",{\"key\": \"-\", \"popup\": \"|\"},\"HOME\",\"UP\",\"END\",\"KEYBOARD\"],\n" +
                               "[\"TAB\",\"CTRL\",\"ALT\",\"LEFT\",\"DOWN\",\"RIGHT\",\"PASTE\"]]";
        SharedPreferences.Editor editor = p.edit();
        editor.putString("extra_keys_config", defaultLayout);
        editor.apply();
    }
    ...
    // Other initialization code...
        ...
        // Set the default text for the extra keys config
        String defaultLayout = "[[\"ESC\",\"/\",{\"key\": \"-\", \"popup\": \"|\"},\"HOME\",\"UP\",\"END\",\"KEYBOARD\"],\n" +
                               "[\"TAB\",\"CTRL\",\"ALT\",\"LEFT\",\"DOWN\",\"RIGHT\",\"PASTE\"]]";
        String savedLayout = preferences.getString("extra_keys_config", defaultLayout);
        config.setText(savedLayout);
        ...
        new android.app.AlertDialog.Builder(getActivity())
            ...
            .setPositiveButton("OK",
                (dialog, whichButton) -> {
                    // Save the new layout
                    String newLayout = config.getText().toString();
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putString("extra_keys_config", newLayout);
                    editor.apply();
                }
            )
